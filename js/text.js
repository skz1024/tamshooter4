...
export class systemText {
  ...
  static gameError = {
    ...
    LOAD_ERROR_MESSAGE2: '세이브 데이터는 삭제됩니다. 게임을 새로고침 해주세요.',
    LOAD_ERROR_MESSAGE3: 'The save data is corrupted or invalid.',
    LOAD_ERROR_MESSAGE4: 'Save data is deleted. Please refresh the game.',
