...
export class imageDataInfo {
  ...
  static meteoriteEnemy = {
    ...
    class31: { x: 0, y: 100, width: 48, height: 48, frame: 1 },
    class32: { x: 50, y: 100, width: 48, height: 48, frame: 1 },
    class33: { x: 100, y: 100, width: 48, height: 48, frame: 1 },
    class34: { x: 150, y: 100, width: 48, height: 48, frame: 1 },
    class35: { x: 200, y: 100, width: 48, height: 48, frame: 1 },
    whiteMeteo1: { x: 500, y: 0, width: 70, height: 50, frame: 1 },
    ...
    blackMeteo1: { x: 500, y: 50, width: 80, height: 45, frame: 1 },
    ...
    bomb: {x: 500, y: 100, width: 60, height: 60, frame: 8},
    bombBig: {x: 500, y: 100, width: 60, height: 60, frame: 1},
    ...
    stoneBlack: {x: 331, y: 0, width: 80, height: 80, frame: 1},
    stoneBlackPiece1: {x: 331, y: 0, width: 40, height: 40, frame: 1},
    stoneBlackPiece2: {x: 371, y: 0, width: 40, height: 40, frame: 1},
    stoneBlackPiece3: {x: 371, y: 40, width: 40, height: 40, frame: 1},
    stoneBlackPiece4: {x: 331, y: 40, width: 40, height: 40, frame: 1},
    stoneGreen: {x: 412, y: 0, width: 80, height: 80, frame: 1},
    stoneGreenPiece1: {x: 412, y: 0, width: 40, height: 40, frame: 1},
    stoneGreenPiece2: {x: 452, y: 0, width: 40, height: 40, frame: 1},
    stoneGreenPiece3: {x: 452, y: 40, width: 40, height: 40, frame: 1},
    stoneGreenPiece4: {x: 412, y: 40, width: 40, height: 40, frame: 1},
  ...
  static towerEnemyGroup3 = {
    ...
    clockAnalogHand: new ImageDataObject(1761, 499, 160, 160, 1),
