...
dataExportStatRound.set(ID.round.round3_5, new StatRound(35, '3-5', '안티 제물', 25, 70000, 610, 130000, ''))
...
dataExportStatRound.set(ID.round.round3_10, new StatRound(-1, '3-10', '동그라미 마을로 돌아가는 길', 25, 77000, 447, 160000, ''))
